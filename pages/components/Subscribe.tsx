export default function Subscribe() {
  return (
    <div className="flex flex-col max-w-4xl md:h-56 bg-white rounded-lg shadow-lg overflow-hidden md:flex-row my-10">
      <div className="md:flex items-center justify-center md:w-1/2 md:bg-green-600">
      ...
      <div className="flex items-center justify-center pb-6 md:py-0 md:w-1/2 md:border-b-8 border-green-600">
        <form>
          <div className="flex flex-col rounded-lg overflow-hidden sm:flex-row">
            ...
            />
            <button className="py-3 px-4 bg-green-600 text-gray-100 font-semibold uppercase hover:bg-gray-600">
              subscribe
            </button>
          </div>
        </form>
